...
export const initialConnections: WhatsAppConnection[] = [
  {
    id: 'conn-1',
    name: 'WhatsApp Principal - Evolution API',
  ...
  {
    id: 'conn-2',
    name: 'WhatsApp Direct - Baileys Engine',
    phone: '+55 11 97700-1122',
    provider: 'baileys',
    apiUrl: 'wss://baileys.meudominio.com',
    apiKey: 'BAILEYS_AUTH_TOKEN_7700',
    instanceName: 'baileys-session-suporte',
    webhookUrl: 'https://meudominio.com/api/baileys/webhook',
    baileysSessionId: 'baileys_sess_suporte_24h',
    usePairingCode: true,
    pairingCode: '8492-7103',
    ...
    botEnabled: true,
    botId: 'bot-1',
    botGreetingMessage: 'Bem-vindo ao Suporte Técnico Prioritário 24/7 via Baileys Engine. Aguarde um instante!',
    completionMessage: 'Atendimento encerrado pela equipe de suporte. Qualquer dúvida técnica adicional, pode nos chamar novamente!',
  ...
  {
    id: 'conn-3',
    name: 'WhatsApp Filial Rio - Baileys WS',
    phone: '+55 21 98822-3344',
    provider: 'baileys',
    apiUrl: 'wss://baileys.meudominio.com',
    apiKey: 'BAILEYS_AUTH_TOKEN_RJ88',
    instanceName: 'baileys-session-rj',
    webhookUrl: 'https://meudominio.com/api/baileys/webhook-rj',
    baileysSessionId: 'baileys_sess_rj_branch',
    usePairingCode: false,
    baileysVersion: '@whiskeysockets/baileys v6.7.8',
    browserName: 'Ubuntu / Chrome',
    status: 'disconnected',
...
export const initialTickets: Ticket[] = [
  {
    ...
    connectionId: 'conn-1',
    queueId: 'queue-1',
    protocol: 'PROT-20260728-101',
    status: 'in_progress',
    priority: 'high',
    tags: ['VIP', 'Proposta'],
    unreadCount: 1,
    createdAt: '2026-07-28T07:10:00Z',
    updatedAt: '2026-07-28T07:45:00Z',
  ...
  },
  {
    ...
    contactId: 'cont-1',
    contact: initialContacts[0],
    assignedAttendantId: 'att-1', // Carlos (Admin)
    departmentId: 'dept-vendas',
    connectionId: 'conn-1',
    queueId: 'queue-1',
    protocol: 'PROT-20260727-088',
    status: 'resolved',
    priority: 'high',
    tags: ['Renovação', 'Encerrado'],
    unreadCount: 0,
    createdAt: '2026-07-27T09:15:00Z',
    updatedAt: '2026-07-27T10:30:00Z',
    closedAt: '2026-07-27T10:30:00Z',
    rating: 5,
    lastMessageSnippet: 'Contrato renovado com sucesso por 12 meses!',
  ...
  },
  {
    ...
    connectionId: 'conn-2',
    queueId: 'queue-2',
    protocol: 'PROT-20260726-042',
    status: 'resolved',
    priority: 'medium',
    tags: ['Dúvida', 'Resolvido'],
    unreadCount: 0,
    createdAt: '2026-07-26T14:00:00Z',
    updatedAt: '2026-07-26T14:22:00Z',
    closedAt: '2026-07-26T14:22:00Z',
    rating: 4,
    lastMessageSnippet: 'Ajuste de configuração efetuado com sucesso.',
